...
def get_result(plantID, devID, type):
    """Get the last entries on the light field and decides if it is necessary or not
    to irrigate.
    """
    ...
    #"http://127.0.0.1:8081/data/p_1002/light?time=hours&tval=2&plantID=p_1002&devID=d_1005"
